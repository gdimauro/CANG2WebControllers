...
namespace NG2Sample.Commerce.ShoppingCart
{
  ...
  */
  ...
  public abstract partial class ShoppingCartContainer
  {
    #region FIELD DECLARATIONS ShoppingCartContainer
    
    private  System.DateTime _creationDate;
    #endregion

    #region FIELD ASSOCIATIONS ShoppingCartContainer
    ...
    #region PROPERTIES ShoppingCartContainer
    /**
    * 
    */
  ...
  #region NAVIGATION PROPERTIES ShoppingCartContainer
  public WebUser WebUser {
    ...
    set { _webUser = value;
        #region FIXUPS ShoppingCartContainer
    if(value.ShoppingCartContainer != this)
      value.ShoppingCartContainer = this; 
    #endregion
  ...
  public abstract partial class Account
  {
    ...
    // association: Account_ShoppingCart 
    private ShoppingCartContainer _cart;  
  ...
  public ShoppingCartContainer ShoppingCartContainer {
  ...
  public abstract partial class WebUser
  {
    ...
    // association: WebUser_ShoppingCart 
    private ShoppingCartContainer _shoppingCart;  
  ...
  public abstract partial class LineItem
  {
    ...
    // association: ShoppingCart_LineItem 
    private ShoppingCartContainer _sc;  
